...
import { baseurl, logined, userinfo } from "../config/recoil/atom.ts";
...
export default function defaultpage() {
  return (
    <div className={"bg-bg1 bg-center bg-no-repeat sm:bg-stretch h-full  "}>
      <Navtop />
      <div
        className={
          "flex justify-around flex-col-reverse sm:flex-row bg-gradient-to-t from-white/5 "
        }
      >
...
function Buton({ isloading }: { isloading: boolean }) {
  return (
    <button
      type="submit"
      className=" flex justify-center w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
    >
      {isloading ? (
        <span className="px-2.5 py-2.5">Login to your account</span>
      ) : (
        <svg
          className="h-10"
