...
import { userinfo, baseurl } from "../../config/recoil/atom";
  ...
  return (
    <div className="bg-sky-700 h-full sm:h-screen flex justify-center items-center w-full p-1 sm:p-10">
      <div className="bg-white rounded-xl h-full w-full p-2 m-2 sm:m-10 ">
        <div className=" text-3xl font-bold text-center">Loan Application</div>
        {step === 1 ? (
          <Step1 setstate={setstep} />
        ) : step === 2 ? (
          <Step2
            setstate={setstep}
            amount={amount}
    ...
    <div className="h-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div className="col-span-2 text-xl font-semibold p-2">
          ...
          <div className="border-2 rounded-md p-2 flex justify-between">
            <input
              ...
              type="date"
              alt="date"
              className="h-7 rounded-xl border-none text-sky-800 cursor-pointer"
            />
            {dobflag == 1 ? (
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="col-span-2 text-xl font-semibold p-2 text-left w-full">
          <div>
            Applicants must be over 21 years of age to proceed with the loan
            request.
          </div>
        </div>
        <div className="col-span-2 text-xl font-semibold p-2">
          ...
          <div className="border-2 rounded-md p-2 flex justify-between">
            <input
              onChange={(e) => {
                if (e.target.value) setpanflag(true);
              }}
              type="text"
              alt="PanNumber"
              className="w-full h-7 rounded-s border-none text-sky-800 cursor-pointer"
            />
            {panflag ? (
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="col-span-2 text-xl font-semibold p-2">
          ...
          <div>
            {creditflag == -1 &&
              "Credit Score must be above 450 to proceed with the loan request."}
          </div>
        </div>
      </div>
      ...
      <div className="flex h-fit">
        ...
        <div className="text-xl">
          ...
          knowledge. If any information is found to be false, I understand that
          my loan application will be rejected.
        </div>
      </div>
      <div className="flex h-fit">
        <input type="checkbox" className="h-5 w-5 mr-4" />
    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <div className="col-span-2 text-xl font-semibold p-2">
          ...
          <div className="border-2 rounded-md p-2 flex justify-between">
            <input
              onChange={(e) => props.setanualincome(e.target.value)}
              type="number"
              alt="PanNumber"
              className="w-full h-7 rounded-s border-none text-sky-800 cursor-pointer"
            />
        ...
        <div className="col-span-2 text-xl font-semibold p-2 ">
          ...
          <div>{numWords(calculateTotalAmount() | 0)}</div>
        </div>
      </div>
      <div className="flex">
        <input type="checkbox" className="h-5 w-5 mr-4" />
      ...
      <div className="flex">
        <input type="checkbox" className="h-5 w-5 mr-4" />
        <div className="text-2xl">
          I understand that late payments may incur additional fees or penalties
...
function Step3(props: any) {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      axios
        .post(url + "/loan", data, { headers: { Authorization: h } })
        .then(() => {
          setflag(true);
        })
        .catch(() => {
    ...
    <div className="h-full">
      ...
      <div className="mt-5 flex justify-center items-center ">
        {!flag ? (
          ...
          <div className="flex flex-col justify-center items-center text-lime-600">
            <svg
              className="w-96 h-56 text-lime-600"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
            ...
            <span className="text-sky-900">
              Amoutn will credit to your wallet shortly
            </span>
          </div>
        )}
      </div>
