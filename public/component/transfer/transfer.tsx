    ...
    <div className="pl-2 pr-2 sm:pl-14 sm:pr-14 pb-1 pt-8 bg-sky-700 h-full sm:h-screen">
      ...
      <div className="flex justify-around h-20 pb-2 text-white">
        <div
          ...
          className={
            (!flag ? "bg-cyan-300 rounded-lg shadow-md " : " ") +
            "   w-full flex flex-col items-center justify-center font-semibold text-xl hover:text-2xl transition-all cursor-pointer "
          }
        >
          <div>Send Money</div>
        </div>
