...
import { baseurl, navatom, userinfo } from "../../config/recoil/atom";
...
export default function Wallet() {
  ...
  const f = () => {
    ...
    axios
      .post(url + "/wallet", { id: id }, { headers: { Authorization: h } })
      .then((res) => {
        setTransc(res.data);
      })
      .catch((err) => {
  ...
  function updateuser() {
    ...
    axios
      .post(url + "/user", { id: user._id }, { headers: { Authorization: id } })
      .then((res) => {
  ...
  return (
    <div className="sm:p-10 flex h-full sm:h-screen justify-center sm:flex-row flex-col bg-sky-700">
