...
import { userinfo } from "../../config/recoil/atom";
    ...
    <div className="sm:w-1/3 h-auto sm:mb-8">
      <div className="h-full p-4 m-4 bg-white rounded-xl shadow-lg">
        <div className="bg-cyan-100 rounded-lg ">
          <div className="text-4xl pt-4 font-bold text-center">
            ₹ {user.balance}
          </div>
          <div className=" pt-4 text-xl font-bold text-center">
            Account Balance
          </div>
        ...
        <div className="pt-4">
          <span className="bg-blue-100 text-blue-800 text-xl font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">
            Account Details
          </span>
          <div className="pt-3 flex ">
            ...
            <div className="ml-4 bg-blue-100 text-blue-800 text-l font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-blue-400 border border-blue-400">
              {" "}
              {user.email}
            </div>
          </div>
