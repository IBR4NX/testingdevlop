...
import { baseurl, logined, userinfo } from "../../config/recoil/atom";
...
export default function Register() {
  ...
  return (
    <section className="bg-regbg bg-center bg-no-repeat h-screen ">
          ...
          <div className="w-auto space-y-6 sm:p-8">
            <form onSubmit={register}>
              ...
              <div className="flex flex-col">
                <button
                  type="submit"
                  className=" self-center w-2/3 text-white hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 bg-blue-700 opacity-100"
                >
                  Create an account
                </button>
                <div className="self-center">{messange}</div>
              </div>
            </form>
          </div>
