...
import { baseurl, payment, userinfo } from "../../config/recoil/atom";
...
export default function Send(props: React.PropsWithChildren<any>) {
  ...
  function verify(form: React.FormEvent<HTMLFormElement>) {
    ...
    axios
      .post(url + `/payment/verifyDetails`, data, {
  ...
  function sendRequest(form: React.FormEvent<HTMLFormElement>) {
    ...
    axios
      ...
      .then((res) => {
        ...
        axios
          .post(url + "/payment/sendRequest", data2, {
            headers: { Authorization: h },
          })
          .then(() => {
          ...
          <form onSubmit={props.text === "Send" ? verify : sendRequest}>
            <ul className="flex justify-around flex-col sm:flex-row ">
              <li className="m-3 sm:m-0">
                ...
                <label
                  htmlFor="uid"
                  className="flex  justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700"
                >
            ...
            <div className="flex flex-col sm:flex-row">
              <div className="sm:w-1/3 flex flex-col items-center justify-center">
                ...
                <div className="m-5 bg-blue-100 text-blue-800 text-2xl font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">
                  {" "}
                  Account Balance
                </div>
              </div>
              <div className="sm:w-2/3">
                <div className=" sm:m-16 m-5">
                  <label
                    ...
                    className="block mb-8 text-2xl font-medium text-gray-900 dark:text-white"
                  >
                    Enter UID / E-Mail / Number
                  </label>
                ...
                <div className="flex flex-col items-center justify-center">
                  ...
                  <button
                    type="submit"
                    className=" text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-2xl px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
                  >
                    {props.text}
                  </button>
                </div>
